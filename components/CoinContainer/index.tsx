...
const CoinContainer = (props: any) => {
  return (
    <div className={props.className}>
      <Link href="/coins/[id]" as={`/coins/${props.id}`}>
        <a>
          <div className="hover:scale-105 duration-200 bg-mayo4 rounded-md ">
